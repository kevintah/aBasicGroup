...
\section{Algebra}
    This group is an abelian Lie algebra following from the fact that $G_1$, $G_2$,  $G_3$ are abelian and the product of the groups $G_i$ is topological. This means the Lie brackets are trivial and structure constants must be trivial.
